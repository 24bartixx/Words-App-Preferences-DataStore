...
class LetterListFragment : Fragment() {
    ...
    // dataStore which holds which LayoutManager should be used
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // convert preferenceFlow to LiveData
        ...
        return when (item.itemId) {
            R.id.action_switch_layout -> {
                ...
                lifecycleScope.launch {
                    settingsDataStore.saveLayoutToThePreferences(isLinearLayoutManager, requireContext())
                }
